...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    processAPI: {
        ...
        onStatusUpdate: (callback) => {
            electron_1.ipcRenderer.on(types_1.IPC_CHANNELS.PROCESS_STATUS_UPDATE, (_, id, status) => callback(id, status));
        }
    },
    // Config
    configAPI: {
    ...
    // Logs
    logAPI: {
        read: (processId, type, lines) => electron_1.ipcRenderer.invoke(types_1.IPC_CHANNELS.LOG_READ, processId, type, lines),
